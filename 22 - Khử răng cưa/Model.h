...
public:
	...
	MoHinh(const char* file, GLuint nhanban = 1, std::vector<glm::mat4> matran = {});
...
private:
	...
	std::vector<glm::mat4> maTranLuoi, maTranBan;

	// chạy 1 lưới = chỉ số
	void taiLuoi(GLuint mluoi);
	// đi qua một nút theo cách đệ quy để đi qua hết tất cả các node kết nối nhau
	void nodeQua(GLuint next, glm::mat4 matran = glm::mat4(1.0f));
