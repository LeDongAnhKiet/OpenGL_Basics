...
{ //			Vị trí		    /		Màu sắc		 /	    Kết cấu	      /		Thường		//
	ToaDo{ glm::vec3(-1.0f, 0.0f,  1.0f), glm::vec3(0.0f, 1.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f), glm::vec2(0.0f, 0.0f) },
	ToaDo{ glm::vec3(-1.0f, 0.0f, -1.0f), glm::vec3(0.0f, 1.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f), glm::vec2(0.0f, 2.0f) },
	ToaDo{ glm::vec3(1.0f , 0.0f, -1.0f), glm::vec3(0.0f, 1.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f), glm::vec2(2.0f, 2.0f) },
	ToaDo{ glm::vec3(1.0f , 0.0f,  1.0f), glm::vec3(0.0f, 1.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f), glm::vec2(2.0f, 0.0f) }
};
// các thứ tự điểm
GLuint thutu[] =
{
...
ToaDo diemSang[] =
{
	ToaDo{ glm::vec3(0.5f, 0.01f, 0.5f) },
	ToaDo{ glm::vec3(0.5f, 0.01f, 0.2f) },
	ToaDo{ glm::vec3(0.8f, 0.01f, 0.2f) },
	ToaDo{ glm::vec3(0.8f, 0.01f, 0.5f) },
	ToaDo{ glm::vec3(0.5f, 0.31f, 0.5f) },
	ToaDo{ glm::vec3(0.5f, 0.31f, 0.2f) },
	ToaDo{ glm::vec3(0.8f, 0.31f, 0.2f) },
	ToaDo{ glm::vec3(0.8f, 0.31f, 0.5f) }
};
...
int main()
{
	...
	GocNhin gocNhin(doRong, doCao, glm::vec3(0.5f, 0.2f, 1.5f));
